...
export default function BookingHeader() {
    return (
       ...
       <div className=" flex flex-col md:flex-row justify-center items-center text-center  gap-4">
        ...
        <button className="p-4 w-auto border border-blue-700 text-blue-700 hover:bg-blue-700 hover:text-white">
        ...
        <button className=" w-auto hover:bg-slate-700  hover:text-white flex justify-center items-center">
